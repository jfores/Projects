...
cd GSE20711
mkdir Data
cd /media/data/jaume/BreastCancer/Data/GSE20711/Data/
wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE20nnn/GSE20711/suppl/GSE20711_RAW.tar
wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE20nnn/GSE20711/soft/GSE20711_family.soft.gz
tar -xf GSE20711_RAW.tar
gunzip *.CEL.gz 
...
```{r}
"/media/data/jaume/BreastCancer/Data/GSE20711/Data/"
"/media/data/jaume/BreastCancer/Data/GSE20711/Data/"
GEO_dat  <- getGEO(filename= "/media/data/jaume/BreastCancer/Data/GSE20711/Data/GSE20711_family.soft.gz")
```
...
files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE20711/Data/",full.names = T)
...
datafile <- buildFileTable(rootDir="/media/data/jaume/BreastCancer/Data/GSE20711/Data")
...
directory_files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE20711/Data",full.names = T)
...
arrayQualityMetrics_All_Groups(GEO_Eset_Raw,"/home/jaume/Projects/BreastMapper/Data/GSE20711/Quality/",var = "pCh_Status",do.logtransform = FALSE) #Already tranformed to log scale.
                               
Tum_Data_QC  <- get_outliers_info(get(load(file="/home/jaume/Projects/BreastMapper/Data/GSE20711/Quality/Results/Pre_Norm/T/Raw_array_quality_metrics_Results.Rda")))
nrow(Tum_Data_QC)
...
pData(GEO_Eset_Norm)$pCh_Batch <- rep("GSE20711",ncol(GEO_Eset_Norm))
...
pData(GEO_Eset_Norm_frma)$pCh_Batch <- rep("GSE20711",ncol(GEO_Eset_Norm_frma))
...
save(file = "/home/jaume/Projects/BreastMapper/Data/GSE20711/Data/GSE20711_Norm.Rda",list_data_norm)
GEO_Eset_Norm <- get(load(file = "/home/jaume/Projects/BreastMapper/Data/GSE20711/Data/GSE20711_Norm.Rda"))

...
cd GSE17705
mkdir Data
cd /media/data/jaume/BreastCancer/Data/GSE17705/Data/
wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE17nnn/GSE17705/suppl/GSE17705_RAW.tar
wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE17nnn/GSE17705/soft/GSE17705_family.soft.gz
tar -xf GSE17705_RAW.tar
gunzip *.CEL.gz 
...
```{r}
"/media/data/jaume/BreastCancer/Data/GSE17705/Data/"
"/media/data/jaume/BreastCancer/Data/GSE17705/Data/"
GEO_dat  <- getGEO(filename= "/media/data/jaume/BreastCancer/Data/GSE17705/Data/GSE17705_family.soft.gz")
```
...
GEO_dat  <- getGEO(filename=file.path(getwd(),"Data/GSE17705/Data/GSE17705_family.soft.gz"))
platforms <- unlist(lapply(GPLList(GEO_dat),function(x) Meta(x)$geo_accession)) 
pData_GEO_dat <- get_pData_table(GEO_dat,platforms[[1]])
rownames(pData_GEO_dat) <- pData_GEO_dat$geo_accession
View(pData_GEO_dat)
...
#pCh_T_Code <- pData_GEO_dat$pCh_t

#pCh_N_Code <- pData_GEO_dat$pCh_n

pCh_Node <- pData_GEO_dat$pCh_nodal_status_.0.negative._1.positive._na.not_applicable.
#pCh_Node[pCh_Node == "N0"] <- "0"
#pCh_Node[pCh_Node == "N1"] <- "1"

pCh_ER_Status <- pData_GEO_dat$pCh_estrogen_receptor_.er._status
...
pCh_DFS_T <- pData_GEO_dat$pCh_event_time_.years.
pCh_DFS_T <- as.numeric(pData_GEO_dat$pCh_event_time_.years.)*12
#pCh_DFS_T <- as.numeric(pCh_DFS_T)/days_to_months

pCh_DFS_E <- pData_GEO_dat$pCh_distant_relapse_.1.dr._0_censored.
...
files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE17705/Data/",full.names = T)
...
datafile <- buildFileTable(rootDir="/media/data/jaume/BreastCancer/Data/GSE17705/Data")
...
directory_files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE17705/Data",full.names = T)
...
arrayQualityMetrics_All_Groups(GEO_Eset_Raw,"/home/jaume/Projects/BreastMapper/Data/GSE17705/Quality/",var = "pCh_Status",do.logtransform = FALSE) #Already tranformed to log scale.
                               
Tum_Data_QC  <- get_outliers_info(get(load(file="/home/jaume/Projects/BreastMapper/Data/GSE17705/Quality/Results/Pre_Norm/T/Raw_array_quality_metrics_Results.Rda")))
nrow(Tum_Data_QC)
...
pData(GEO_Eset_Norm)$pCh_Batch <- rep("GSE17705",ncol(GEO_Eset_Norm))
...
pData(GEO_Eset_Norm_frma)$pCh_Batch <- rep("GSE17705",ncol(GEO_Eset_Norm_frma))
...
save(file = "/home/jaume/Projects/BreastMapper/Data/GSE17705/Data/GSE17705_Norm.Rda",list_data_norm)
GEO_Eset_Norm <- get(load(file = "/home/jaume/Projects/BreastMapper/Data/GSE17705/Data/GSE17705_Norm.Rda"))

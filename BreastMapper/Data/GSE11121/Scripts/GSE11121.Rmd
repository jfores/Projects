...
#cd /media/data/jaume/BreastCancer/Data/GSE11121/Data/
#wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE11nnn/GSE11121/suppl/GSE11121_RAW.tar
#wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE11nnn/GSE11121/soft/GSE11121_family.soft.gz
...
```{r}
"/media/data/jaume/BreastCancer/Data/GSE11121/Data/"

GEO_dat  <- getGEO(filename= "/media/data/jaume/BreastCancer/Data/GSE11121/Data/GSE11121_family.soft")
```
...
files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE11121/Data/",full.names = T)
...
#directory_files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE11121/Data",full.names = T)
...
datafile<-buildFileTable(rootDir="/media/data/jaume/BreastCancer/Data/GSE11121/Data")
...
arrayQualityMetrics_All_Groups(GEO_Eset_Raw,"/home/jaume/Projects/BreastMapper/Data/GSE11121/Quality/",var = "pCh_Status",do.logtransform = FALSE) #Already tranformed to log scale.
                               
Tum_Data_QC  <- get_outliers_info(get(load(file="/home/jaume/Projects/BreastMapper/Data/GSE11121/Quality/Results/Pre_Norm/T/Raw_array_quality_metrics_Results.Rda")))
...
pData(GEO_Eset_Norm)$pCh_Batch <- rep("GSE11121",ncol(GEO_Eset_Norm))
...
pData(GEO_Eset_Norm_frma)$pCh_Batch <- rep("GSE11121",ncol(GEO_Eset_Norm_frma))
```

```{r}
list_data_norm <- list(GEO_Eset_Norm,GEO_Eset_Norm_frma)
save(file = "/home/jaume/Projects/BreastMapper/Data/GSE11121/Data/GSE11121_Norm.Rda",list_data_norm)
GEO_Eset_Norm <- get(load(file = "/home/jaume/Projects/BreastMapper/Data/GSE11121/Data/GSE11121_Norm.Rda"))

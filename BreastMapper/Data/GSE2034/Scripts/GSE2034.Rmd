...
cd GSE2034
mkdir Data
cd /media/data/jaume/BreastCancer/Data/GSE2034/Data/
wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE2nnn/GSE2034/suppl/GSE2034_RAW.tar
wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE2nnn/GSE2034/soft/GSE2034_family.soft.gz
tar -xf GSE2034_RAW.tar
gunzip *.CEL.gz 
...
```{r}
"/media/data/jaume/BreastCancer/Data/GSE2034/Data/"
"/media/data/jaume/BreastCancer/Data/GSE2034/Data/"
GEO_dat  <- getGEO(filename= "/media/data/jaume/BreastCancer/Data/GSE2034/Data/GSE2034_family.soft.gz")
```
...
#Read independent phenotype data table. Copied from https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?view=data&acc=GSE2034&id=40089&db=GeoDb_blob26

pheno_Table <- read.csv(file = "/home/jaume/Projects/BreastMapper/Data/GSE2034/Data/Pheno_For_GSE2034.csv",sep="\t")
rownames(pheno_Table) <- pheno_Table[,2]
...
pCh_Node <- pheno_Table$lymph.node.status
pCh_Node[pCh_Node == "negative"] <- "0"
#pCh_Node[pCh_Node == "LN+"] <- "1"
#pCh_Node[pCh_Node == "LN?"] <- NA

#pCh_Size <-  pData_GEO_dat$pCh_size_.bin.
  
pCh_ER_Status <- pheno_Table$ER.Status
pCh_ER_Status[pCh_ER_Status == "ER-"] <- "0"
pCh_ER_Status[pCh_ER_Status == "ER+"] <- "1"
#pCh_ER_Status[pCh_ER_Status == "ER?"] <- NA
...
#pCh_Grade <- pData_GEO_dat$pCh_Elston_.NGS._histologic_grade

#pCh_HER2_Fish <- pData_GEO_dat$pCh_her2fish

pCh_DFS_T <- pheno_Table$time.to.relapse.or.last.follow.up..months.
#pCh_DFS_T[pCh_DFS_T == "--"] <- NA
pCh_DFS_T <- as.numeric(pCh_DFS_T)

pCh_DFS_E <- pheno_Table$relapse..1.True.
...
files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE2034/Data/",full.names = T)
...
datafile <- buildFileTable(rootDir="/media/data/jaume/BreastCancer/Data/GSE2034/Data")
...
directory_files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE2034/Data",full.names = T)
...
arrayQualityMetrics_All_Groups(GEO_Eset_Raw,"/home/jaume/Projects/BreastMapper/Data/GSE2034/Quality/",var = "pCh_Status",do.logtransform = FALSE) #Already tranformed to log scale.
                               
Tum_Data_QC  <- get_outliers_info(get(load(file="/home/jaume/Projects/BreastMapper/Data/GSE2034/Quality/Results/Pre_Norm/T/Raw_array_quality_metrics_Results.Rda")))
nrow(Tum_Data_QC)
...
pData(GEO_Eset_Norm)$pCh_Batch <- rep("GSE2034",ncol(GEO_Eset_Norm))
...
pData(GEO_Eset_Norm_frma)$pCh_Batch <- rep("GSE2034",ncol(GEO_Eset_Norm_frma))
...
save(file = "/home/jaume/Projects/BreastMapper/Data/GSE2034/Data/GSE2034_Norm.Rda",list_data_norm)
GEO_Eset_Norm <- get(load(file = "/home/jaume/Projects/BreastMapper/Data/GSE2034/Data/GSE2034_Norm.Rda"))

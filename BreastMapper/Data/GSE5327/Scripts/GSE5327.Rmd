...
cd GSE5327
mkdir Data
cd /media/data/jaume/BreastCancer/Data/GSE5327/Data/
wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE5nnn/GSE5327/suppl/GSE5327_RAW.tar
wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE5nnn/GSE5327/soft/GSE5327_family.soft.gz
tar -xf GSE5327_RAW.tar
gunzip *.CEL.gz 
...
```{r}
"/media/data/jaume/BreastCancer/Data/GSE5327/Data/"
"/media/data/jaume/BreastCancer/Data/GSE5327/Data/"
GEO_dat  <- getGEO(filename= "/media/data/jaume/BreastCancer/Data/GSE5327/Data/GSE5327_family.soft.gz")
```
...
pCh_DFS_T <- pData_GEO_dat$pCh_metastasis_free_survival_.yr.
pCh_DFS_T <- as.numeric(pCh_DFS_T)*12

pCh_DFS_E <- pData_GEO_dat$pCh_metastasis
...
files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE5327/Data/",full.names = T)
...
datafile <- buildFileTable(rootDir="/media/data/jaume/BreastCancer/Data/GSE5327/Data")
...
directory_files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE5327/Data",full.names = T)
...
arrayQualityMetrics_All_Groups(GEO_Eset_Raw,"/home/jaume/Projects/BreastMapper/Data/GSE5327/Quality/",var = "pCh_Status",do.logtransform = FALSE) #Already tranformed to log scale.
                               
Tum_Data_QC  <- get_outliers_info(get(load(file="/home/jaume/Projects/BreastMapper/Data/GSE5327/Quality/Results/Pre_Norm/T/Raw_array_quality_metrics_Results.Rda")))
nrow(Tum_Data_QC)
...
pData(GEO_Eset_Norm)$pCh_Batch <- rep("GSE5327",ncol(GEO_Eset_Norm))
...
pData(GEO_Eset_Norm_frma)$pCh_Batch <- rep("GSE5327",ncol(GEO_Eset_Norm_frma))
...
save(file = "/home/jaume/Projects/BreastMapper/Data/GSE5327/Data/GSE5327_Norm.Rda",list_data_norm)
GEO_Eset_Norm <- get(load(file = "/home/jaume/Projects/BreastMapper/Data/GSE5327/Data/GSE5327_Norm.Rda"))

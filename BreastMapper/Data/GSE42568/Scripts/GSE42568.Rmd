...
cd GSE42568
mkdir Data
cd /media/data/jaume/BreastCancer/Data/GSE42568/Data/
...
```{r}
"/media/data/jaume/BreastCancer/Data/GSE42568/Data/"
"/media/data/jaume/BreastCancer/Data/GSE42568/Data/"
GEO_dat  <- getGEO(filename= "/media/data/jaume/BreastCancer/Data/GSE42568/Data/GSE42568_family.soft.gz")
```
...
files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE42568/Data/",full.names = T)
...
datafile <- buildFileTable(rootDir="/media/data/jaume/BreastCancer/Data/GSE42568/Data")
...
directory_files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE42568/Data",full.names = T)
...
arrayQualityMetrics_All_Groups(GEO_Eset_Raw,"/home/jaume/Projects/BreastMapper/Data/GSE42568/Quality/",var = "pCh_Status",do.logtransform = FALSE) #Already tranformed to log scale.
                               
Tum_Data_QC  <- get_outliers_info(get(load(file="/home/jaume/Projects/BreastMapper/Data/GSE42568/Quality/Results/Pre_Norm/T/Raw_array_quality_metrics_Results.Rda")))
nrow(Tum_Data_QC)
delete_tumors <- names(which(rowSums(Tum_Data_QC[,c(1,3,5)]) == 3))

Cont_Data_QC  <- get_outliers_info(get(load(file="/home/jaume/Projects/BreastMapper/Data/GSE42568/Quality/Results/Pre_Norm/NT/Raw_array_quality_metrics_Results.Rda")))
...
save(file = "/home/jaume/Projects/BreastMapper/Data/GSE42568/Data/GSE42568_Norm.Rda",list_data_norm)
GEO_Eset_Norm <- get(load(file = "/home/jaume/Projects/BreastMapper/Data/GSE42568/Data/GSE42568_Norm.Rda"))

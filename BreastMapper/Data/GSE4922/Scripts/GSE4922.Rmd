...
cd GSE4922
mkdir Data
cd /media/data/jaume/BreastCancer/Data/GSE4922/Data/
wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE4nnn/GSE4922/suppl/GSE4922_RAW.tar
wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE4nnn/GSE4922/soft/GSE4922_family.soft.gz
tar -xf GSE4922_RAW.tar
gunzip *.CEL.gz 
...
```{r}
"/media/data/jaume/BreastCancer/Data/GSE4922/Data/"
"/media/data/jaume/BreastCancer/Data/GSE4922/Data/"
GEO_dat  <- getGEO(filename= "/media/data/jaume/BreastCancer/Data/GSE4922/Data/GSE4922_family.soft.gz")
```
...
pCh_DFS_T <- pData_GEO_dat$pCh_DFS_TIME_.yrs.
pCh_DFS_T <- as.numeric(pCh_DFS_T)*12

pCh_DFS_E <- pData_GEO_dat$pCh_DFS_EVENT_.0.censored._1.event_defined_as_any_type_of_recurrence_.local._regional_or_distant._or_death_from_breast_cancer
...
files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE4922/Data/",full.names = T)
file.remove(files_temp[grepl("soft.gz",files_temp)])
file.remove(files_temp[grepl("_RAW.tar",files_temp)])

#Selecting only those files with samples from GPL96 only.

files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE4922/Data/",full.names = T)
file.remove(files_temp[!gsub(".CEL","",gsub(".*/","",files_temp)) %in% rownames(pData_GEO_ft)])

files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE4922/Data/",full.names = T)

#Obtaining md5 for each .CEL file.

datafile <- buildFileTable(rootDir="/media/data/jaume/BreastCancer/Data/GSE4922/Data")
...
directory_files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE4922/Data",full.names = T)
...
arrayQualityMetrics_All_Groups(GEO_Eset_Raw,"/home/jaume/Projects/BreastMapper/Data/GSE4922/Quality/",var = "pCh_Status",do.logtransform = FALSE) #Already tranformed to log scale.
                               
Tum_Data_QC  <- get_outliers_info(get(load(file="/home/jaume/Projects/BreastMapper/Data/GSE4922/Quality/Results/Pre_Norm/T/Raw_array_quality_metrics_Results.Rda")))
nrow(Tum_Data_QC)
...
pData(GEO_Eset_Norm)$pCh_Batch <- rep("GSE4922",ncol(GEO_Eset_Norm))
...
pData(GEO_Eset_Norm_frma)$pCh_Batch <- rep("GSE4922",ncol(GEO_Eset_Norm_frma))
...
save(file = "/home/jaume/Projects/BreastMapper/Data/GSE4922/Data/GSE4922_Norm.Rda",list_data_norm)
GEO_Eset_Norm <- get(load(file = "/home/jaume/Projects/BreastMapper/Data/GSE4922/Data/GSE4922_Norm.Rda"))

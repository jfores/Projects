...
cd GSE21653
mkdir Data
cd /media/data/jaume/BreastCancer/Data/GSE21653/Data/
wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE21nnn/GSE21653/suppl/GSE21653_RAW.tar
wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE21nnn/GSE21653/soft/GSE21653_family.soft.gz
tar -xf GSE21653_RAW.tar
gunzip *.CEL.gz 
...
```{r}
"/media/data/jaume/BreastCancer/Data/GSE21653/Data/"
"/media/data/jaume/BreastCancer/Data/GSE21653/Data/"
GEO_dat  <- getGEO(filename= "/media/data/jaume/BreastCancer/Data/GSE21653/Data/GSE21653_family.soft.gz")
```
...
files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE21653/Data/",full.names = T)
...
datafile <- buildFileTable(rootDir="/media/data/jaume/BreastCancer/Data/GSE21653/Data")
...
directory_files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE21653/Data",full.names = T)
...
arrayQualityMetrics_All_Groups(GEO_Eset_Raw,"/home/jaume/Projects/BreastMapper/Data/GSE21653/Quality/",var = "pCh_Status",do.logtransform = FALSE) #Already tranformed to log scale.
                               
Tum_Data_QC  <- get_outliers_info(get(load(file="/home/jaume/Projects/BreastMapper/Data/GSE21653/Quality/Results/Pre_Norm/T/Raw_array_quality_metrics_Results.Rda")))
nrow(Tum_Data_QC)
...
pData(GEO_Eset_Norm)$pCh_Batch <- rep("GSE21653",ncol(GEO_Eset_Norm))
...
pData(GEO_Eset_Norm_frma)$pCh_Batch <- rep("GSE21653",ncol(GEO_Eset_Norm_frma))
...
save(file = "/home/jaume/Projects/BreastMapper/Data/GSE21653/Data/GSE21653_Norm.Rda",list_data_norm)
GEO_Eset_Norm <- get(load(file = "/home/jaume/Projects/BreastMapper/Data/GSE21653/Data/GSE21653_Norm.Rda"))

...
cd GSE20685
mkdir Data
cd /media/data/jaume/BreastCancer/Data/GSE20685/Data/
wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE20nnn/GSE20685/suppl/GSE20685_RAW.tar
wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE20nnn/GSE20685/soft/GSE20685_family.soft.gz
tar -xf GSE20685_RAW.tar
gunzip *.CEL.gz 
...
```{r}
"/media/data/jaume/BreastCancer/Data/GSE20685/Data/"
"/media/data/jaume/BreastCancer/Data/GSE20685/Data/"
GEO_dat  <- getGEO(filename= "/media/data/jaume/BreastCancer/Data/GSE20685/Data/GSE20685_family.soft.gz")
```
...
pCh_Node <- pData_GEO_dat$pCh_n_stage
...
files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE20685/Data/",full.names = T)
...
datafile <- buildFileTable(rootDir="/media/data/jaume/BreastCancer/Data/GSE20685/Data")
...
directory_files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE20685/Data",full.names = T)
...
arrayQualityMetrics_All_Groups(GEO_Eset_Raw,"/home/jaume/Projects/BreastMapper/Data/GSE20685/Quality/",var = "pCh_Status",do.logtransform = FALSE) #Already tranformed to log scale.
                               
Tum_Data_QC  <- get_outliers_info(get(load(file="/home/jaume/Projects/BreastMapper/Data/GSE20685/Quality/Results/Pre_Norm/T/Raw_array_quality_metrics_Results.Rda")))
nrow(Tum_Data_QC)
...
pData(GEO_Eset_Norm)$pCh_Batch <- rep("GSE20685",ncol(GEO_Eset_Norm))
...
pData(GEO_Eset_Norm_frma)$pCh_Batch <- rep("GSE20685",ncol(GEO_Eset_Norm_frma))
...
save(file = "/home/jaume/Projects/BreastMapper/Data/GSE20685/Data/GSE20685_Norm.Rda",list_data_norm)
GEO_Eset_Norm <- get(load(file = "/home/jaume/Projects/BreastMapper/Data/GSE20685/Data/GSE20685_Norm.Rda"))

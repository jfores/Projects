...
#cd /media/data/jaume/BreastCancer/Data/GSE12093/Data/
#wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE12nnn/GSE12093/suppl/GSE12093_RAW.tar
#wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE12nnn/GSE12093/soft/GSE12093_family.soft.gz
#tar -xf GSE12093_RAW.tar
...
```{r}
"/media/data/jaume/BreastCancer/Data/GSE12093/Data/"

GEO_dat  <- getGEO(filename= "/media/data/jaume/BreastCancer/Data/GSE12093/Data/GSE12093_family.soft.gz")
```
...
files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE12093/Data/",full.names = T)
...
datafile<- buildFileTable(rootDir="/media/data/jaume/BreastCancer/Data/GSE12093/Data")
...
directory_files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE12093/Data",full.names = T)
...
arrayQualityMetrics_All_Groups(GEO_Eset_Raw,"/home/jaume/Projects/BreastMapper/Data/GSE12093/Quality/",var = "pCh_Status",do.logtransform = FALSE) #Already tranformed to log scale.
                               
Tum_Data_QC  <- get_outliers_info(get(load(file="/home/jaume/Projects/BreastMapper/Data/GSE12093/Quality/Results/Pre_Norm/T/Raw_array_quality_metrics_Results.Rda")))
...
pData(GEO_Eset_Norm)$pCh_Batch <- rep("GSE12093",ncol(GEO_Eset_Norm))
...
pData(GEO_Eset_Norm_frma)$pCh_Batch <- rep("GSE12093",ncol(GEO_Eset_Norm_frma))
```
...
save(file = "/home/jaume/Projects/BreastMapper/Data/GSE12093/Data/GSE12093_Norm.Rda",list_data_norm)
GEO_Eset_Norm <- get(load(file = "/home/jaume/Projects/BreastMapper/Data/GSE12093/Data/GSE12093_Norm.Rda"))

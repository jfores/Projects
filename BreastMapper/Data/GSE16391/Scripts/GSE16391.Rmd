...
#cd GSE16391
#mkdir Data
#cd /media/data/jaume/BreastCancer/Data/GSE16391/Data/
#wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE16nnn/GSE16391/suppl/GSE16391_RAW.tar
#wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE16nnn/GSE16391/soft/GSE16391_family.soft.gz
#tar -xf GSE16391_RAW.tar
...
```{r}
"/media/data/jaume/BreastCancer/Data/GSE16391/Data/"

GEO_dat  <- getGEO(filename= "/media/data/jaume/BreastCancer/Data/GSE16391/Data/GSE16391_family.soft.gz")
```
...
pCh_DFS_T <- pData_GEO_dat$pCh_t_rfs_months
pCh_DFS_T_comments <- rep("It is distant metastais free survival expressed in months",nrow(pData_GEO_dat))
pCh_DFS_E <- pData_GEO_dat$pCh_case_control_0._case._1_._control
pCh_DFS_E[pCh_DFS_E == "1"] <- "Other"
pCh_DFS_E[pCh_DFS_E == "0"] <- "1"
pCh_DFS_E[pCh_DFS_E == "Other"] <- "0"
...
files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE16391/Data/",full.names = T)
...
datafile <- buildFileTable(rootDir="/media/data/jaume/BreastCancer/Data/GSE16391/Data")
...
directory_files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE16391/Data",full.names = T)
...
arrayQualityMetrics_All_Groups(GEO_Eset_Raw,"/home/jaume/Projects/BreastMapper/Data/GSE16391/Quality/",var = "pCh_Status",do.logtransform = FALSE) #Already tranformed to log scale.
                               
Tum_Data_QC  <- get_outliers_info(get(load(file="/home/jaume/Projects/BreastMapper/Data/GSE16391/Quality/Results/Pre_Norm/T/Raw_array_quality_metrics_Results.Rda")))
nrow(Tum_Data_QC)
...
pData(GEO_Eset_Norm)$pCh_Batch <- rep("GSE16391",ncol(GEO_Eset_Norm))
...
pData(GEO_Eset_Norm_frma)$pCh_Batch <- rep("GSE16391",ncol(GEO_Eset_Norm_frma))
...
save(file = "/home/jaume/Projects/BreastMapper/Data/GSE16391/Data/GSE16391_Norm.Rda",list_data_norm)
GEO_Eset_Norm <- get(load(file = "/home/jaume/Projects/BreastMapper/Data/GSE16391/Data/GSE16391_Norm.Rda"))

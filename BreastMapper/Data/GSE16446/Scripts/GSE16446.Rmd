...
cd GSE16446
mkdir Data
cd /media/data/jaume/BreastCancer/Data/GSE16446/Data/
wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE16nnn/GSE16446/suppl/GSE16446_RAW.tar
wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE16nnn/GSE16446/soft/GSE16446_family.soft.gz
tar -xf GSE16446_RAW.tar
gunzip *.CEL.gz 
...
```{r}
"/media/data/jaume/BreastCancer/Data/GSE16446/Data/"
"/media/data/jaume/BreastCancer/Data/GSE16446/Data/"
GEO_dat  <- getGEO(filename= "/media/data/jaume/BreastCancer/Data/GSE16446/Data/GSE16446_family.soft.gz")
```
...
pCh_DFS_T <- pData_GEO_dat$pCh_dmfs_time
pCh_DFS_T <- as.numeric(pCh_DFS_T)/days_to_months

pCh_DFS_E <- pData_GEO_dat$pCh_dmfs_event
...
files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE16446/Data/",full.names = T)
...
datafile <- buildFileTable(rootDir="/media/data/jaume/BreastCancer/Data/GSE16446/Data")
...
directory_files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE16446/Data",full.names = T)
...
arrayQualityMetrics_All_Groups(GEO_Eset_Raw,"/home/jaume/Projects/BreastMapper/Data/GSE16446/Quality/",var = "pCh_Status",do.logtransform = FALSE) #Already tranformed to log scale.
                               
Tum_Data_QC  <- get_outliers_info(get(load(file="/home/jaume/Projects/BreastMapper/Data/GSE16446/Quality/Results/Pre_Norm/T/Raw_array_quality_metrics_Results.Rda")))
nrow(Tum_Data_QC)
...
pData(GEO_Eset_Norm)$pCh_Batch <- rep("GSE16446",ncol(GEO_Eset_Norm))
...
pData(GEO_Eset_Norm_frma)$pCh_Batch <- rep("GSE16446",ncol(GEO_Eset_Norm_frma))
...
save(file = "/home/jaume/Projects/BreastMapper/Data/GSE16446/Data/GSE16446_Norm.Rda",list_data_norm)
GEO_Eset_Norm <- get(load(file = "/home/jaume/Projects/BreastMapper/Data/GSE16446/Data/GSE16446_Norm.Rda"))

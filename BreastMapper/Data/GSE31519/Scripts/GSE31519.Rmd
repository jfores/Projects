...
cd GSE31519
mkdir Data
cd /media/data/jaume/BreastCancer/Data/GSE31519/Data/
wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE31nnn/GSE31519/suppl/GSE31519_RAW.tar
wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE31nnn/GSE31519/soft/GSE31519_family.soft.gz
tar -xf GSE31519_RAW.tar
gunzip *.CEL.gz 
...
```{r}
"/media/data/jaume/BreastCancer/Data/GSE31519/Data/"
"/media/data/jaume/BreastCancer/Data/GSE31519/Data/"
GEO_dat  <- getGEO(filename= "/media/data/jaume/BreastCancer/Data/GSE31519/Data/GSE31519_family.soft.gz")
```
...
pCh_DFS_T <- pData_GEO_dat$pCh_event.free_interval_.months.

#a_temp <- pData_GEO_dat$pCh_regional_relapse
#b_temp <- pData_GEO_dat$pCh_event_metastasis
#b_temp[a_temp=="1"] <- 1

pCh_DFS_E <- pData_GEO_dat$pCh_event_.1
pCh_DFS_E[pCh_DFS_E == "yes,_0"] <- "1"
#pCh_DFS_E[is.na(pCh_DFS_E)] <- "0"


pCh_Node <- pData_GEO_dat$pCh_lymph_node_status_.0
pCh_Node[pCh_Node == "negative,_1"] <- "0"
#pCh_Node[pCh_Node == "3"] <- "1"
#pCh_Node[pCh_Node == "--"] <- NA

pCh_Size <-  pData_GEO_dat$pCh_tumor_size_.1
  
#pCh_ER_Status <- pData_GEO_dat$pCh_er_ihc
#pCh_ER_Status[pCh_ER_Status == "neg"] <- "0"
#pCh_ER_Status[pCh_ER_Status == "pos"] <- "1"
#pCh_ER_Status[pCh_ER_Status == "--"] <- NA

#pCh_PR_Status <- pData_GEO_dat$pCh_pr_ihc
#pCh_PR_Status[pCh_PR_Status == "neg"] <- "0"
#pCh_PR_Status[pCh_PR_Status == "pos"] <- "1"
#pCh_PR_Status[pCh_PR_Status == "--"] <- NA

#pCh_ERBB2_Status <- pData_GEO_dat$pCh_erbb2
...
#pCh_Grade <- pData_GEO_dat$pCh_sbr_grade

#pCh_HER2_Fish <- pData_GEO_dat$pCh_her2fish

#pCh_DFS_T <- pData_GEO_dat$pCh_dfs_time_.months.
#pCh_DFS_T[pCh_DFS_T == "--"] <- NA
#pCh_DFS_T <- as.numeric(pCh_DFS_T)*12

#pCh_DFS_E <- pData_GEO_dat$pCh_dfs_evt
...
files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE31519/Data/",full.names = T)
file.remove(files_temp[grepl("soft.gz",files_temp)])
file.remove(files_temp[grepl("_RAW.tar",files_temp)])
file.remove(files_temp[grepl(".CEL.gz",files_temp)])


#Obtaining md5 for each .CEL file.

datafile <- buildFileTable(rootDir="/media/data/jaume/BreastCancer/Data/GSE31519/Data")
...
directory_files_temp <- dir("/media/data/jaume/BreastCancer/Data/GSE31519/Data",full.names = T)
...
arrayQualityMetrics_All_Groups(GEO_Eset_Raw,"/home/jaume/Projects/BreastMapper/Data/GSE31519/Quality/",var = "pCh_Status",do.logtransform = FALSE) #Already tranformed to log scale.
                               
Tum_Data_QC  <- get_outliers_info(get(load(file="/home/jaume/Projects/BreastMapper/Data/GSE31519/Quality/Results/Pre_Norm/T/Raw_array_quality_metrics_Results.Rda")))
nrow(Tum_Data_QC)
...
pData(GEO_Eset_Norm)$pCh_Batch <- rep("GSE31519",ncol(GEO_Eset_Norm))
...
pData(GEO_Eset_Norm_frma)$pCh_Batch <- rep("GSE31519",ncol(GEO_Eset_Norm_frma))
...
pData(GEO_Eset_Norm)
save(file = "/home/jaume/Projects/BreastMapper/Data/GSE31519/Data/GSE31519_Norm.Rda",list_data_norm)
GEO_Eset_Norm <- get(load(file = "/home/jaume/Projects/BreastMapper/Data/GSE31519/Data/GSE31519_Norm.Rda"))

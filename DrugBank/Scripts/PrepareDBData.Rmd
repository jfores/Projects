...
```{r}
source("/home/jaume/Projects/GitRepos/Functions/LINCS_And_DB_Fun.R")
...
get(load(file = "/media/data/jaume/DrugBank/Data/classification_1_all.Rmd"))
...
external_IDs_wide <- pivot_wider(external_IDs,names_from = "resource",values_from = "identifier" )
View(external_IDs_wide)
length(external_IDs_wide$parent_key)
length(unique(external_IDs_wide$parent_key))
rownames(external_IDs_wide) <- external_IDs_wide$parent_key
...
Drugs_All <- left_join(Drugs_All, df_Smiles_Filt,by = "primary_key")
